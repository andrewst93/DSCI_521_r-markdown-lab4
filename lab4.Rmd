...
<https://github.ubc.ca/MDS-2022-23/DSCI_521_lab4_andrews9>
...
```{r}
paste0("This is a formatted output with a float: ", 1.234, " and a classic string: ", "Foo Bar")
```
...
paste0("This is my first named code-chunk, great success!")
...
The following code chunk uses echo = FALSE allows for the code that
produced the output to be be hidden in the knitted document.
...
paste0("The result of ", x, " times ", y, " is ", round(x*y, 2))
```
...
The following code chunk uses two options, eval is whether or not the
chunk should be evaluated on knit, which we want set to FALSE. And echo
= TRUE allows for the code to be shown in the final knitted document.
...
Q7.1:
<https://github.ubc.ca/MDS-2022-23/DSCI_521_lab4_andrews9/blob/master/Q7-rmarkdown-file.html>

Q7.2:
<https://github.ubc.ca/MDS-2022-23/DSCI_521_lab4_andrews9/blob/master/Q7-rmarkdown-file.pdf>
...
Q8 MD html file:
<https://github.ubc.ca/MDS-2022-23/DSCI_521_lab4_andrews9/blob/master/Q8-new-rmarkdown-file.html>
...
The guthub_document markdown file displays in visual form instead of raw
text like the Rmd files. This i nice to have finalized analysis/reports
accessible to team without having to download/view and open.

Link to github_document:
<https://github.ubc.ca/MDS-2022-23/DSCI_521_lab4_andrews9/blob/master/Q8-new-rmarkdown-file.md>
